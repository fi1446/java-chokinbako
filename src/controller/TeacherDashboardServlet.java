...
public class TeacherDashboardServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (TeacherLoginModel.login(request.getParameter("teacher_loginid"),
				request.getParameter("teacher_password"))) {
			...
			teacherCourseInfoBeans = TeacherDashboardModel.getTeacherCourseInfo(teacherCourseInfoBeans,
					teacherInfoBeans.getCourses_id(), teacherInfoBeans.getTeachers_id());
